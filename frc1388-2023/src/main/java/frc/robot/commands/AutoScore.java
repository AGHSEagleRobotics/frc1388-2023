...
public class AutoScore extends CommandBase {
  private PrimaryArmSubsystem m_armSubsystem;
  ...
  public AutoScore(double mainArmPosition, double wristPosition, double grabberPosition, PrimaryArmSubsystem armSubsystem, GrabberSubsystem grabberSubsystem) {
